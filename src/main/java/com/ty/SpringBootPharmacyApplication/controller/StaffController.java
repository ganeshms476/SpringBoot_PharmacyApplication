...
public class StaffController {
	...
	@ApiOperation(value = "update staff", notes = " Api is used to update the staff using staff id, admin id and medical store id")
	...
	@ApiOperation(value = "get staff id", notes = " Api is used to get the staff")
